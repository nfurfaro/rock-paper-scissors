...
contract('RockPaperScissors', accounts => {
    ...
    it("should let Alice or Bob play", () => {
        let secret = "broccoli ants beach appartment"
        let hashedPlay = web3.sha3(secret, 1);
        console.log(hashedPlay);
        return instance.playSecretHand(hashedPlay, {from: Alice, value: ante})
            .then(txObj => {
